...
namespace Discount_Server.Services
{
    ...
    class Parser : IParser
    {
        ...
        /// </summary>
        /// <returns>Лист магазинов. Значение может быть null.</returns>
        public async Task<List<ShopInfoModel>?> GetShopListAsync()
        {
            return shops;
        }
        ...
        /// <param name="shop"> Лист продуктов будет из данного магазина </param>
        /// <returns>Лист продуктов из указанного магазина. Значение может быть null.</returns>
        public async Task<List<ProductInfoModel>?> GetProductListAsync(ShopInfo shop)
        {
        ...
        List<ShopInfoModel> IParser.GetShopList()
        {
            return shops;
        }

        List<ProductInfoModel> IParser.GetProductList(ShopInfoModel shop)
        {
            List<ProductInfoModel> products = new List<ProductInfoModel>();
